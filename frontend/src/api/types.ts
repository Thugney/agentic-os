...
export type Workspace={name?:string;path?:string;description?:string;default_branch?:string;current_branch?:string;git_status?:string;allowed_commands?:string[];allowed_agents?:string[];memory_scopes?:string[];linked_sessions?:number;status?:string;error?:string;[key:string]:any};
export type AgentDefinition={name:string;label?:string;provider?:string;model?:string;role?:string;workspace?:string;allowed_tools?:string[];workspace_access?:string[];memory_scopes?:string[];mcp_channels?:string[];system_prompt?:string;approval_policy?:string;enabled?:boolean;[key:string]:any};
...
export type KanbanTask={id:string;title:string;description?:string;status:string;priority?:string;assigned_agent?:string;schedule?:string;due_at?:string;approval_gate?:string;workspace?:string;agent_session?:string;git_branch?:string;artifact?:string;chat_thread?:string;created_at?:string;updated_at?:string};
export type MemoryRecord={id:string;title:string;content:string;scope:string;tags?:string| string[];source_session?:string;source_type?:string;source_name?:string;workspace?:string;agent?:string;created_at?:string;updated_at?:string};
...
export type EffectiveSettings={providers?:any[];agents?:AgentDefinition[];workspaces?:Workspace[];skills?:any[];[key:string]:any};
